	...
	jRange.prototype = {
		...
		template: '<div class="slider-container">\
			<div class="back-bar">\
                ...
                <img class="pointer low" src="../img/progress.png" alt="" /><div class="pointer-label mins">123456</div>\
                <img class="pointer high" src="../img/progress.png" alt="" /><div class="pointer-label maxs">456789</div>\
		...
		renderScale: function() {
			...
			$('ins', this.scale).each(function(index) {
				if(index==0){
					$(this).css({
						marginLeft:0
					});
